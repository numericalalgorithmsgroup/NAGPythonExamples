...
Figure 1 shows an illustrative simple problem of data fitting ([Jupyter Notebook](./python/orbit_ex.ipynb)). The task is to find the optimal orbit path given a variety of measurements for which the orbit has to approximatly pass-by.
...
# More Info [TODO fix links]
 ...
 [[Python Jupyter notebook for this example](./python/simple_BXNL.ipynb)]
...
The [Jupyter notebook](./simple_BXNL.ipynb) uses `e04gg` to fit the
